...
//Exercise 1: Log JUST the name of the Pokemon with the number 59 using the index of the Pokemon in the array. 
console.log(pokemon[58].name);

//Exercise 2: Take a moment to familiarize yourself with the game object being logged.
//console.log(game)
...
*/
//console.log(pokemon[149], pokemon[150], pokemon[130]);
game.party.push(pokemon[149], pokemon[150], pokemon[130]);
//console.log(game);
...
//to call it, dont forget to use `game.catchPokemon()`, calling only `catchPokemon` wont work!
...
*/
//i was finding this item inside of the party, maybe i added it by mistake?
game.items = [
    { name: 'pokeball', quantity: 8 }
  ];
...
*/
console.log(game);
//It looks like I did 3 copies of the document? 😳 How come?
//I deleted the items "potion" and "rare candy". lol 
game.items = [
    { name: "potion", quantity: 4 },
    { name: 'pokeball', quantity: 8 },
    { name: "rare candy", quantity: 99 },
